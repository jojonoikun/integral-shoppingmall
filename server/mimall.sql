...
INSERT INTO `admin` VALUES (2, 'dio', '123456');
INSERT INTO `admin` VALUES (3, 'jojo', '123456');
...
-- Records of adonhome
-- ----------------------------
INSERT INTO `adonhome` VALUES (1, 0, '中石化', 'https://oss-xpc0.xpccdn.com/uploadfile/article/2018/10/22/5bcd673b140ab.jpeg?x-oss-process=image%2Fresize%2Cw_3840%2Fquality%2Cq_60');
...
INSERT INTO `adsontop` VALUES (38, '加油充值卡', NULL, '中国石油2元电子充值卡', 'http://www.jf.95504.net/upload/product/e6d0c46f-9079-4589-8a07-8b08c55b8952.jpg', 2.00);
INSERT INTO `adsontop` VALUES (39, '加油充值卡', NULL, '中国石油10元电子充值卡', 'http://www.jf.95504.net/upload/product/e5de5f63-1777-408c-9dce-b96527dec571.jpg', 10.00);
INSERT INTO `adsontop` VALUES (40, '加油充值卡', NULL, '中国石油20元电子充值卡', 'http://www.jf.95504.net/upload/product/25fce846-bb7e-4ab8-ba8a-283116154f90.jpg', 20.00);
INSERT INTO `adsontop` VALUES (41, '加油充值卡', NULL, '中国石油30元电子充值卡', 'http://www.jf.95504.net/upload/product/0d97ab9e-7be5-412b-a499-9632c6dd410d.jpg', 30.00);
INSERT INTO `adsontop` VALUES (42, '加油充值卡', NULL, '中国石油50元电子充值卡', 'http://www.jf.95504.net/upload/product/027b3508-8f74-4e6c-b389-0bbb1daca6c0.jpg', 50.00);
INSERT INTO `adsontop` VALUES (43, '加油充值卡', NULL, '中国石油100元电子充值卡', 'http://www.jf.95504.net/upload/product/751c22b3-6d2e-462b-89dc-ffcc5d915078.jpg', 100.00);
...
CREATE TABLE `phones`  (
  ...
  `showid` int(11) NOT NULL,
  `src` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cartimage` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `relevantitems` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `maxamounts` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`Id`) USING BTREE
...
CREATE TABLE `recommend`  (
  ...
  `like` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `src` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `memory` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `color` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `searchgoods`  (
  ...
  `src` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `price` decimal(10, 2) NULL DEFAULT NULL,
  `show` tinyint(255) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `searchgoods` VALUES (1, '中国石油5元电子充值卡', 'http://www.jf.95504.net/upload/product/e6d0c46f-9079-4589-8a07-8b08c55b8952.jpg', 5.00, 0);
INSERT INTO `searchgoods` VALUES (2, '中国石油10元电子充值卡', 'http://www.jf.95504.net/upload/product/e5de5f63-1777-408c-9dce-b96527dec571.jpg', 10.00, 0);
INSERT INTO `searchgoods` VALUES (3, '中国石油20元电子充值卡', 'http://www.jf.95504.net/upload/product/25fce846-bb7e-4ab8-ba8a-283116154f90.jpg', 20.00, 0);
INSERT INTO `searchgoods` VALUES (4, '中国石油30元电子充值卡', 'http://www.jf.95504.net/upload/product/0d97ab9e-7be5-412b-a499-9632c6dd410d.jpg', 30.00, 0);
INSERT INTO `searchgoods` VALUES (5, '中国石油50元电子充值卡', 'http://www.jf.95504.net/upload/product/027b3508-8f74-4e6c-b389-0bbb1daca6c0.jpg', 50.00, 0);
INSERT INTO `searchgoods` VALUES (6, '中国石油100元电子充值卡', 'http://www.jf.95504.net/upload/product/751c22b3-6d2e-462b-89dc-ffcc5d915078.jpg', 100.00, 0);
INSERT INTO `searchgoods` VALUES (7, '中国石油200元电子充值卡', 'http://www.jf.95504.net/upload/product/4eae6ca4-ae40-4170-a90b-632c69cb9ca4.jpg', 200.00, 0);
INSERT INTO `searchgoods` VALUES (8, '中国石油500元电子充值卡', 'http://www.jf.95504.net/upload/product/485c7020-7eb9-495c-9adc-3360fc3cecb0.jpg', 500.00, 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 1, 'jojo', '123456');
INSERT INTO `user` VALUES (2, 2, 'dio', '123456');
INSERT INTO `user` VALUES (3, 3, 'zhangsan', '123456');
INSERT INTO `user` VALUES (4, 4, '56465da', '165498');
INSERT INTO `user` VALUES (5, 5, 'lkil', '1654849daw');
INSERT INTO `user` VALUES (6, 6, '666', '666');
INSERT INTO `user` VALUES (7, 7, 'dadaa', 'dadada');
INSERT INTO `user` VALUES (8, 8, 'kaixin', '123456');
INSERT INTO `user` VALUES (9, 9, 'diopop', '123456');
INSERT INTO `user` VALUES (10, 10, '张三', '123456');
INSERT INTO `user` VALUES (11, 11, 'coco', '123456');
INSERT INTO `user` VALUES (12, 12, '李四', '123456');
INSERT INTO `user` VALUES (13, 13, '王五', '123456');
INSERT INTO `user` VALUES (14, 14, '赵六', '123456');
INSERT INTO `user` VALUES (15, 15, '赵东', '123456');
...
-- ----------------------------
INSERT INTO `useraddress` VALUES (1, 4, '吉林 长春市 朝阳区', '前卫大街2699号吉林大学', '胡博润', '18212345678', '学校', 0);
INSERT INTO `useraddress` VALUES (2, 4, '北京 北京市 东城区', '东城区三街道', '张三', '18222222822', '测试', 0);
INSERT INTO `useraddress` VALUES (4, 8, '重庆 重庆市 渝中区', '北京路1307号', 'jojo', '15983292544', 'd', 0);
INSERT INTO `useraddress` VALUES (5, 2, '北京 北京市 西城区', '北京路21号', '张三', '15819181198', 'd', 0);
INSERT INTO `useraddress` VALUES (7, 2, '天津 天津市 和平区', '顶顶顶顶顶', '李四', '15819181195', '李四', 0);
INSERT INTO `useraddress` VALUES (9, 13, '吉林 吉林市 昌邑区', '张三d达娃大 ', '王五', '15826494465', '王五', 0);
INSERT INTO `useraddress` VALUES (10, 13, '天津 天津市 和平区', 'coocdddd', 'dddd', '15648491156', 'cooc', 0);
INSERT INTO `useraddress` VALUES (11, 13, '北京 北京市 西城区', '广州工商学院三水校区', '李四', '15816174498', '学校', 0);
...
INSERT INTO `usercart` VALUES (35, 3, 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', 1699.00, 2, 0);
INSERT INTO `usercart` VALUES (36, 3, 'Xiaomi MIX FOLD', '16GB+512GB', '黑色', 9999.00, 1, 0);
INSERT INTO `usercart` VALUES (37, 3, 'Xiaomi MIX 4', '8GB+128GB', '陶瓷黑', 4199.00, 1, 0);
INSERT INTO `usercart` VALUES (38, 3, 'Redmi K40', '8GB+256GB', '幻境', 2099.00, 1, 0);
INSERT INTO `usercart` VALUES (39, 11, 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', 1699.00, 3, 1);
INSERT INTO `usercart` VALUES (40, 12, 'Redmi Note 11 Pro', '8GB+256GB', '迷雾森林', 2099.00, 1, 1);
INSERT INTO `usercart` VALUES (41, 15, 'Redmi Note 11 Pro', '8GB+256GB', '浅梦星河', 2099.00, 1, 1);
INSERT INTO `usercart` VALUES (43, 14, 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', 1699.00, 2, 1);
INSERT INTO `usercart` VALUES (44, 1, 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', 1699.00, 1, 1);
INSERT INTO `usercart` VALUES (45, 10, 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', 1699.00, 1, 1);
...
CREATE TABLE `userorder`  (
  ...
  `receivername` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `show` tinyint(255) NOT NULL,
  PRIMARY KEY (`id`, `userid`, `orderid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 123 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of userorder
-- ----------------------------
INSERT INTO `userorder` VALUES (35, 4, 100001, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '10', 2299.00, 0, '2023-05-11 14:26:14', 0);
INSERT INTO `userorder` VALUES (36, 4, 100001, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '7', 5499.00, 0, '2023-04-15 15:46:37', 0);
INSERT INTO `userorder` VALUES (41, 4, 100003, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-01 11:32:20', 0);
INSERT INTO `userorder` VALUES (42, 4, 100003, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-01 11:32:20', 0);
INSERT INTO `userorder` VALUES (43, 4, 100003, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-01 11:32:20', 0);
INSERT INTO `userorder` VALUES (44, 4, 100003, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-01 11:32:20', 0);
INSERT INTO `userorder` VALUES (45, 4, 100004, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-01 12:58:06', 0);
INSERT INTO `userorder` VALUES (46, 4, 100004, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-01 12:58:06', 0);
INSERT INTO `userorder` VALUES (47, 4, 100004, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '3', 2299.00, 0, '2023-05-11 18:10:22', 0);
INSERT INTO `userorder` VALUES (48, 4, 100004, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-01 12:58:06', 0);
INSERT INTO `userorder` VALUES (49, 4, 100005, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-01 06:03:15', 0);
INSERT INTO `userorder` VALUES (50, 4, 100005, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-01 13:03:15', 0);
INSERT INTO `userorder` VALUES (51, 4, 100005, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-01 13:03:15', 0);
INSERT INTO `userorder` VALUES (52, 4, 100005, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-01 13:03:15', 0);
INSERT INTO `userorder` VALUES (53, 4, 100006, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-02 10:18:38', 0);
INSERT INTO `userorder` VALUES (54, 4, 100006, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-02 10:18:38', 0);
INSERT INTO `userorder` VALUES (55, 4, 100006, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-02 10:18:38', 0);
INSERT INTO `userorder` VALUES (56, 4, 100006, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-02 10:18:38', 0);
INSERT INTO `userorder` VALUES (57, 4, 100007, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-02 10:30:39', 0);
INSERT INTO `userorder` VALUES (58, 4, 100007, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-02 10:30:39', 0);
INSERT INTO `userorder` VALUES (59, 4, 100007, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-02 10:30:39', 0);
INSERT INTO `userorder` VALUES (60, 4, 100007, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-02 10:30:39', 0);
INSERT INTO `userorder` VALUES (61, 4, 100008, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-02 10:41:12', 0);
INSERT INTO `userorder` VALUES (62, 4, 100008, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-02 10:41:12', 0);
INSERT INTO `userorder` VALUES (63, 4, 100008, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-02 10:41:12', 0);
INSERT INTO `userorder` VALUES (64, 4, 100008, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-02 10:41:12', 0);
INSERT INTO `userorder` VALUES (65, 4, 100009, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-02 10:58:46', 0);
INSERT INTO `userorder` VALUES (66, 4, 100009, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-02 10:58:46', 0);
INSERT INTO `userorder` VALUES (67, 4, 100009, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-02 10:58:46', 0);
INSERT INTO `userorder` VALUES (68, 4, 100009, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-02 10:58:46', 0);
INSERT INTO `userorder` VALUES (69, 4, 100010, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-02 11:17:05', 0);
INSERT INTO `userorder` VALUES (70, 4, 100010, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-02 11:17:05', 0);
INSERT INTO `userorder` VALUES (71, 4, 100010, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-02 11:17:05', 0);
INSERT INTO `userorder` VALUES (72, 4, 100010, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-02 11:17:05', 0);
INSERT INTO `userorder` VALUES (73, 4, 100011, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-03 10:28:49', 0);
INSERT INTO `userorder` VALUES (74, 4, 100011, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-03 10:28:49', 0);
INSERT INTO `userorder` VALUES (75, 4, 100011, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-03 10:28:49', 0);
INSERT INTO `userorder` VALUES (76, 4, 100011, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-03 10:28:49', 0);
INSERT INTO `userorder` VALUES (77, 4, 100012, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-04 09:36:29', 0);
INSERT INTO `userorder` VALUES (78, 4, 100012, '胡博润', '1', 'Redmi K40', '8GB+256GB', '幻境', '1', 2099.00, 0, '2022-01-04 09:36:29', 0);
INSERT INTO `userorder` VALUES (79, 4, 100012, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-04 09:36:29', 0);
INSERT INTO `userorder` VALUES (80, 4, 100012, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-04 09:36:29', 0);
INSERT INTO `userorder` VALUES (81, 4, 100013, '胡博润', '1', 'Redmi K40', '12GB+256GB', '墨羽', '6', 2299.00, 0, '2022-01-07 17:22:26', 0);
INSERT INTO `userorder` VALUES (82, 4, 100013, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-07 17:22:26', 0);
INSERT INTO `userorder` VALUES (83, 4, 100013, '胡博润', '1', 'Xiaomi MIX 4', '8GB+256GB', '影青灰', '1', 4469.00, 0, '2022-01-07 17:22:26', 0);
INSERT INTO `userorder` VALUES (84, 4, 100013, '胡博润', '1', 'Xiaomi MIX FOLD', '12GB+256GB', '黑色', '5', 6999.00, 0, '2022-01-07 17:22:26', 0);
INSERT INTO `userorder` VALUES (85, 4, 100014, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-07 17:24:57', 0);
INSERT INTO `userorder` VALUES (86, 4, 100015, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-07 17:31:02', 0);
INSERT INTO `userorder` VALUES (87, 4, 100015, '胡博润', '1', 'Xiaomi 11 Ultra', '12GB+512GB', '陶瓷白', '1', 6499.00, 0, '2022-01-07 17:31:02', 0);
INSERT INTO `userorder` VALUES (88, 4, 100015, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-07 17:31:02', 0);
INSERT INTO `userorder` VALUES (89, 4, 100015, '胡博润', '1', 'Xiaomi MIX 4', '8GB+128GB', '陶瓷黑', '5', 4199.00, 0, '2022-01-07 17:31:02', 0);
INSERT INTO `userorder` VALUES (90, 4, 100015, '胡博润', '1', 'Xiaomi MIX 4', '8GB+256GB', '影青灰', '1', 4469.00, 0, '2022-01-07 17:31:02', 0);
INSERT INTO `userorder` VALUES (91, 4, 100015, '胡博润', '1', 'Xiaomi MIX FOLD', '12GB+256GB', '黑色', '5', 6999.00, 0, '2022-01-07 17:31:02', 0);
INSERT INTO `userorder` VALUES (92, 4, 100016, '胡博润', '1', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '5', 1699.00, 0, '2022-01-07 17:56:24', 0);
INSERT INTO `userorder` VALUES (93, 4, 100016, '胡博润', '1', 'Xiaomi 11 Ultra', '12GB+512GB', '陶瓷白', '1', 6499.00, 0, '2022-01-07 17:56:24', 0);
INSERT INTO `userorder` VALUES (94, 4, 100016, '胡博润', '1', 'Xiaomi MIX 4', '12GB+512GB', '陶瓷白', '1', 5499.00, 0, '2022-01-07 17:56:24', 0);
INSERT INTO `userorder` VALUES (95, 4, 100016, '胡博润', '1', 'Xiaomi MIX 4', '8GB+128GB', '陶瓷黑', '5', 4199.00, 0, '2022-01-07 17:56:24', 0);
INSERT INTO `userorder` VALUES (96, 4, 100016, '胡博润', '1', 'Xiaomi MIX 4', '8GB+256GB', '影青灰', '1', 4469.00, 0, '2022-01-07 17:56:24', 0);
INSERT INTO `userorder` VALUES (97, 4, 100016, '胡博润', '1', 'Xiaomi MIX FOLD', '12GB+256GB', '黑色', '5', 6999.00, 0, '2022-01-07 17:56:24', 0);
INSERT INTO `userorder` VALUES (98, 4, 100017, '胡博润', '1', 'Xiaomi 11 Ultra', '12GB+512GB', '陶瓷黑', '1', 6499.00, 0, '2022-01-09 12:16:03', 0);
INSERT INTO `userorder` VALUES (99, 4, 100017, '胡博润', '1', 'Redmi K40', '12GB+256GB', '亮黑', '7', 2299.00, 0, '2022-01-09 12:16:03', 0);
INSERT INTO `userorder` VALUES (100, 8, 100018, 'jojo', '5', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '10', 1699.00, 0, '2023-05-11 20:48:01', 0);
INSERT INTO `userorder` VALUES (101, 1, 100019, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '7', 1699.00, 0, '2023-05-11 20:55:30', 0);
INSERT INTO `userorder` VALUES (102, 1, 100020, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '神秘黑境', '1', 1699.00, 0, '2023-04-02 13:28:22', 0);
INSERT INTO `userorder` VALUES (103, 1, 100021, 'jojo', '3', 'Redmi Note 11 Pro', '8GB+256GB', '浅梦星河', '1', 2099.00, 0, '2023-04-02 13:46:26', 0);
INSERT INTO `userorder` VALUES (104, 1, 100022, 'jojo', '3', 'Xiaomi MIX 4', '8GB+128GB', '陶瓷黑', '1', 4199.00, 0, '2023-04-02 13:48:43', 0);
INSERT INTO `userorder` VALUES (105, 1, 100023, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '3', 1699.00, 0, '2023-04-02 14:19:59', 0);
INSERT INTO `userorder` VALUES (106, 1, 100024, 'jojo', '3', 'Xiaomi 11 Ultra', '12GB+256GB', '陶瓷白', '1', 5999.00, 0, '2023-04-02 14:22:59', 0);
INSERT INTO `userorder` VALUES (107, 1, 100025, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '1', 1699.00, 0, '2023-04-02 14:32:51', 0);
INSERT INTO `userorder` VALUES (108, 1, 100026, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '迷雾森林', '1', 1699.00, 0, '2023-04-02 14:34:30', 0);
INSERT INTO `userorder` VALUES (109, 1, 100027, 'jojo', '3', 'Redmi Note 11 Pro', '8GB+256GB', '时光精紫', '1', 2099.00, 0, '2023-04-02 14:37:37', 0);
INSERT INTO `userorder` VALUES (110, 1, 100028, 'jojo', '3', 'Redmi Note 11 Pro', '8GB+256GB', '迷雾森林', '1', 2099.00, 0, '2023-04-02 16:00:12', 0);
INSERT INTO `userorder` VALUES (111, 1, 100029, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '1', 1699.00, 0, '2023-4-9 19:59:28', 0);
INSERT INTO `userorder` VALUES (112, 1, 100030, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '1', 1699.00, 0, '2023-4-9 20:3:58', 0);
INSERT INTO `userorder` VALUES (113, 1, 100031, 'jojo', '3', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '1', 1699.00, 0, '2023-5-7 16:58:43', 0);
INSERT INTO `userorder` VALUES (114, 1, 100032, 'jojo', '3', 'Xiaomi 11 Ultra', '12GB+256GB', '陶瓷白', '1', 5999.00, 0, '2023-5-7 17:26:42', 0);
INSERT INTO `userorder` VALUES (115, 2, 100033, '张三', '5', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '4', 1699.00, 0, '2023-5-8 20:32:21', 0);
INSERT INTO `userorder` VALUES (116, 2, 100034, '李四', '7', 'Redmi Note 11 Pro', '8GB+256GB', '浅梦星河', '2', 2099.00, 0, '2023-5-8 20:37:37', 0);
INSERT INTO `userorder` VALUES (117, 1, 100035, 'jojoo', '3', 'Xiaomi 11 Ultra', '12GB+256GB', '陶瓷白', '1', 5999.00, 0, '2023-5-8 20:44:12', 0);
INSERT INTO `userorder` VALUES (118, 10, 100036, '张三', '8', 'Redmi Note 11 Pro', '8GB+128GB', '时光精紫', '3', 1899.00, 0, '2023-5-9 16:19:49', 0);
INSERT INTO `userorder` VALUES (119, 10, 100037, '张三', '8', 'Xiaomi MIX 4', '8GB+128GB', '陶瓷黑', '1', 4169.00, 0, '2023-5-9 18:46:42', 0);
INSERT INTO `userorder` VALUES (120, 10, 100038, '张三', '8', 'Redmi Note 11 Pro', '8GB+256GB', '迷雾森林', '2', 2099.00, 0, '2023-5-9 18:51:35', 0);
INSERT INTO `userorder` VALUES (121, 1, 100039, 'jojoo', '3', 'Xiaomi MIX 4', '8GB+128GB', '陶瓷黑', '1', 4169.00, 0, '2023-5-9 22:49:2', 0);
INSERT INTO `userorder` VALUES (122, 13, 100040, '王五', '9', 'Redmi Note 11 Pro', '6GB+128GB', '浅梦星河', '2', 1699.00, 0, '2023-5-10 15:32:14', 0);
