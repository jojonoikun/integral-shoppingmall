    ...
    <div class="site-topbar">
      <div class="container">
        <div class="topbar-navi">
          <a href="/">加油卡积分商城</a><span class="sep">|</span>
          <a href="https://www.95504.net/">门户网站</a
          ><span class="sep">|</span>
          <a href="http://www.jf.95504.net/help/jifenPlan">帮助中心</a
          ><span class="sep">|</span> <a href="javascript:;">热线服务</a
          ><span class="sep">|</span
          ><a href="http://localhost:8080/" style="margin-right: 28px"
            >后台管理</a
          >
          <span>您好！欢迎访问昆仑加油卡积分商城！</span>
        </div>
        <div
          class="topbar-cart"
            ...
            <div class="cart-container-all" v-show="showCart">
              ...
              <div id="overflowContainer">
                ...
                >
                  ...
                  <div class="cart-item-price">{{ cart.price }}积分</div>
