      ...
      <div class="order">
        ...
        <div class="commodity">
          ...
          >
            ...
            <span>{{ item.price }}积分 x {{ item.amount }}</span>
            <span>{{ item.price * item.amount }}积分</span>
          </div>
        </div>
        <div class="text2">
          <span>配送方式</span>
        ...
        <div class="price">
          ...
          <div>
            <span>商品总价：</span
            ><span>{{ $store.getters.totalChosenPrice }}积分</span>
          </div>
          <div><span>活动优惠：</span><span>-0积分</span></div>
          <div><span>优惠劵抵扣：</span><span>-0积分</span></div>
          <div><span>运费：</span><span>-0积分</span></div>
          <div>
            <span>应付总额：</span
