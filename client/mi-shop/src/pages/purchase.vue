    ...
    >
      ...
      <div class="other">
        ...
        <div class="sketch">
          ...
          <div class="message1">积分商城自营</div>
          <div class="prices">
            <span class="newPrice">{{ prices[currentChoice1] }}积分</span>
            <span
              v-if="prices[currentChoice1] != oldPrices[currentChoice1]"
              class="oldPrice"
              >{{ oldPrices[currentChoice1] }}积分</span
            >
          </div>
        ...
        <div class="order">
          <div class="phoneMessage">
            ...
            {{ colors[currentChoice2] }}积分
            <div
              class="phonePrice"
              v-if="prices[currentChoice1] != oldPrices[currentChoice1]"
            >
              {{ prices[currentChoice1] }}积分
              <span>{{ oldPrices[currentChoice1] }}积分</span>
            </div>
            <div class="phonePrice" v-else>
              {{ prices[currentChoice1] }}积分
            </div>
          </div>
          <div class="totalPrice">总计：{{ prices[currentChoice1] }}积分</div>
        </div>
        <div class="purchase">
        ...
        <div class="otherText">
          <i class="iconfont icon-duihao"></i><span>积分商城自营</span>
          <i class="iconfont icon-duihao"></i><span>积分发货</span>
